...
class HospitalLogin extends Component {
    constructor() {
      ...
      onSubmit(e) {
        ...
        axios.post('https://limitless-refuge-36101.herokuapp.com/Hospital/login', {
          email: user.email,
      ...
      render() {
        return (
          ...
          <div className="body">
         {this.state.loggedin && (
          <Navigate to="/Home/Hos/PatientReg" replace={true} />
        )}
          <div className="container my-5">
            <div className="row">
              <div className="col-md-6 mt-5 mx-auto">
                <form Validate onSubmit={this.onSubmit}>
                  <h1 className="h3 mb-3 mt-5 font-weight-normal btn-rg">Please sign in as Hospital</h1>
